  ...
  <h1>软件更新早知道</h1>
  <ul>
<li>近期由于身体原因暂停更新软件.深感抱歉。如果软件到期打不开。那么把本地时间改成软件压缩包的时间在加一天就行。感谢大家对本软件的支持</li>
 <li>最近爆出很多漏洞如用友nc命令执行等，无奈身体原因力不从心。不能实时更新。非常抱歉预计6月下旬最迟7月中旬更新软件。再次感谢大家对软件得支持</li>
<li>另外说一下跑沙箱检测的有爆毒。怀疑是木马文件的这些人联系删除本软件别用就行。此软件采用c#和c++混合开发另外加了net和c++的强壳。如果爆毒属于正常如果有人担心木马病毒那么建议删除本软件。另外软件免费。我没有求着你们用。软件打不开的问题看git说明。别动不动脑残就知道发issu </li>

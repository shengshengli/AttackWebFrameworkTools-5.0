...
<h2>漏洞提交样本下载</h2>
<ul><li>漏洞提交样本下载:提交漏洞到一定数量好处可以内部自己使用!!!! 样本地址
https://wwi.lanzouq.com/b09yufllg 密码:fyc4</li></ul>
...
<ul>
  <li>更新日志记录软件已经停止更新!!!</li>
      <li>2022-04-03 新增 Spring Cloud Function SPEL表达式注入漏洞 CVE-2022-22963(springboot),spring core rce检测  CVE-2022-22965(spring) 。修复git 信息泄露漏洞,weaverOa8 sql注入误报,yongyouu8 信息泄露误报问题。感谢反馈!!! </li>

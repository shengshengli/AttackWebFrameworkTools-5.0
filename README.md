  ...
  <h1>软件更新早知道</h1>
  <ul>
  <li>下一版本将补weblogic漏洞将新增,spring data  Spring Cloud 漏洞敬请期待!!!!</li>
  </ul>
...
ofbiz<br/>
jboss<br/>
如果会在软件同目录下生产shell.txt。攻击不成功则不会生成。DVR 如果跑出来密码是空的那么说明不需要密码只要用户名登陆即可。注意webcam为摄像头漏洞合集类如果以后摄像头有新漏洞那么就在webcam这个参数里面
</ul>
<h2>软件使用注意事项</h2>
<ul>
